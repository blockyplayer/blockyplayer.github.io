...
def speech_search():
    ...
    with sr.AudioFile("temp.wav") as source:
        ...
        ASSEMBLE_KEY = '63426fbd53af430d911df5373d0455c3'
        transcript_text = r.recognize_assemblyai(audio_data, ASSEMBLE_KEY)
    ...
    client = OpenAI(api_key="sk-e7d1b516083e4b64ad395acfc95ab466", base_url="https://api.deepseek.com")

    response = client.chat.completions.create(
        model="deepseek-chat",
        messages=[
            {"role": "system", "content": "You are Jarvis from the Iron Man films."},
